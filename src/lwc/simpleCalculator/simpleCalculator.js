import { LightningElement, track } from 'lwc'; // import track as well
export default class SimpleCalculator extends LightningElement {
    @track result; // decorator to track the result
    num1;
    num2;
    ...
    onButtonCLick(event) {
        ...
        if (!isNaN(this.num1) && !isNaN(this.num2)) {
            ...
            var tempResult = 0;
            if (operation === 'Add') {
                tempResult = `${numb1 + numb2}`; // using backticks(literal) instead of + operator
